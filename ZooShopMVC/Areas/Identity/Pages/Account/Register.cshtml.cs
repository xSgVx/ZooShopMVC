...
namespace ZooShopMVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var user = CreateUser();
                var user = new ApplicationUser { FullName = Input.FullName, Email = Input.Email , PhoneNumber = Input.PhoneNumber, UserName = Input.Email};
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        //only admin-logged creates admin users
                        await _userManager.AddToRoleAsync(user, WC.AdminRole);
                    }
                    else
                    {
